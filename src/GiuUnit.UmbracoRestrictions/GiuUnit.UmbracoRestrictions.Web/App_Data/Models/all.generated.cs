...
[assembly:ModelsBuilderAssembly(PureLive = true, SourceHash = "8f1d309c2d818991")]
...
#pragma warning restore 0109
	...
	[PublishedContentModel("globalConfiguration")]
	public partial class GlobalConfiguration : PublishedContentModel
	{
#pragma warning disable 0109 // new is redundant
		public new const string ModelTypeAlias = "globalConfiguration";
		public new const PublishedItemType ModelItemType = PublishedItemType.Content;
#pragma warning restore 0109

		public GlobalConfiguration(IPublishedContent content)
			: base(content)
		{ }
...
#pragma warning restore 0109
		...
		public static PublishedPropertyType GetModelPropertyType<TValue>(Expression<Func<GlobalConfiguration, TValue>> selector)
		{
			return PublishedContentModelUtility.GetModelPropertyType(GetModelContentType(), selector);
		}
	}
